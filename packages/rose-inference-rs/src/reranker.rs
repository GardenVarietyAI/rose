...
impl RerankerModel {
    ...
    fn py_new(
        ...
        let model = load_reranker(&model_path, &device_config.device)
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to load reranker: {}", e)))?;
    ...
    fn score<'py>(
        ...
        future_into_py(py, async move {
            ...
            let score = model_guard
                ...
                .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Scoring error: {}", e)))?;
