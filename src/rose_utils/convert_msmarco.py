"""
Convert MS-MARCO MiniLM reranker to ONNX.
"""
...
def convert_msmarco(
    model_path: Path = typer.Argument(Path("data/models/cross-encoder--ms-marco-MiniLM-L12-v2"), help="Model path"),
    output_path: Path = typer.Argument(Path("data/models/ms-marco-MiniLM-L-12-v2-ONNX"), help="Output directory"),
) -> None:
