...
class Settings(BaseSettings):
    ...
    default_chunk_size: int = Field(default=300, description="Default chunk size in tokens for document chunking")
    default_chunk_overlap: int = Field(default=50, description="Default overlap in tokens between chunks")
