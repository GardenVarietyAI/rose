...
config = Config(
    ...
    hf_model_path=f"{HF_HUB_CACHE}/models--allenai--OLMo-3-7B-Instruct/snapshots/096bb5469fe34348bc88d851a69edb3bf6f40df4",
    dataset_path=f"{HF_HUB_CACHE}/datasets--openlifescienceai--medmcqa/snapshots/91c6572c454088bf71b679ad90aa8dffcd0d5868/data/train-00000-of-00001.parquet",
